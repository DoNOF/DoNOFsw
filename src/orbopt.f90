...
!                                                                      !
!   4) ADAM: Use Adaptative Momentum Gradient Descent                  !
!                                                                      !
!======================================================================!
...
!      
      ...
      LOGICAL :: IMPROVED
      DOUBLE PRECISION :: LR, BETA1, BETA2
!-----------------------------------------------------------------------
      ILOOP = ILOOP
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
!     IUSER
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      DO I=1, MAXLOOP
        ...
        DO J=1,NV
          ...
          MHAT(J) = M(J) / (1.0D0-BETA1**I)
          VHAT(J) = V(J) / (1.0D0-BETA2**I)
          VHATMAX(J) = MAX(VHATMAX(J), VHAT(J))

          Y(J) = -LR*MHAT(J)/(SQRT(VHATMAX(J)) + 10D-8)
        END DO
      ...
      DEALLOCATE(GRAD, MHAT, VHAT, VHATMAX)
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      DO I=1, MAXLOOP
        ...
        DO J=1,NV
          ...
          Y(J) = -LR*M(J)/(SQRT(VHATMAX(J) + 10D-8))
        END DO
